...
/* The 3:2 variant. Same three words and same object, recomposed for a taller
   frame: the gauge sits under the headline rather than beside it, so neither
   element has to shrink. Authored at its own size, never a crop of the 16:9. */
export const Thumb32: React.FC = () => (
  <AbsoluteFill style={{background: C.ink950, padding: 60, justifyContent: 'center'}}>
    <div style={{position: 'absolute', width: 760, height: 620, borderRadius: '50%', left: 300, top: 120,
    ...
    <div style={{position: 'absolute', right: 74, bottom: 96}}>
      <svg width={400} height={225} viewBox="0 0 300 168">
    ...
    <div style={{fontFamily: FONT.display, fontSize: 104, lineHeight: 1.0, color: C.ink100,
      letterSpacing: '-0.035em', maxWidth: 640, marginTop: -40}}>
      Nobody<br />was<br /><span style={{color: C.alarm}}>reading.</span>
    </div>

    <div style={{position: 'absolute', bottom: 48, left: 60, fontFamily: FONT.text,
